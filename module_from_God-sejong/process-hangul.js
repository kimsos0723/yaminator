...
export function is_hangul(hangul) {
...
export function is_word_hangul(word) {
    if (word === undefined) {
...
export function disassemble_hangul(hangul) {
...
export function assemble_hangul(arr) {
...
export function hangul_test(str) {
    var arr = str.split('')
    var txt = ''
